...
function generarQRFactura($pedido) {
    $qrData = "FACTURA BIKE STORE\n" .
              "N°: {$pedido['order_id']}\n" .
              "Cliente: {$pedido['cliente']}\n" .
              "Fecha: {$pedido['order_date']}\n" .
              "Total: Bs " . number_format($pedido['total_amount'], 2) . "\n" .
              "Estado: {$pedido['estado']}\n" .
              "Tienda: {$pedido['store_name']}\n" .
              "Verificar: http://localhost/bike_store";
    ...
    $imagenQR = @file_get_contents($urlAPI);
    
    if ($imagenQR) {
        return base64_encode($imagenQR);
    }
...
// GENERAR CÓDIGO QR
$qrCodeBase64 = generarQRFactura($pedido);
