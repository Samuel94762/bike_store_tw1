...
$error = isset($_GET['error']) ? htmlspecialchars($_GET['error']) : 'Ocurrió un error al procesar el pago';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Pago Fallido - <?php echo APP_NAME; ?></title>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="error-card">
                        ...
                        <h2 class="mb-3">Pago Fallido</h2>
                        <p class="text-muted mb-4">
                            <?php echo $error; ?>
                        </p>
                        
                        <div class="alert alert-warning" role="alert">
                            <i class="bi bi-info-circle"></i> Por favor intenta de nuevo o contacta a soporte si el problema persiste.
                        </div>
